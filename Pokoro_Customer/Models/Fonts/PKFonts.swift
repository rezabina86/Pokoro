...
extension UIFont {
    ...
    struct PKFonts {
        ...
        static var LargeSB : UIFont {
            return UIFont(name: "SFProDisplay-Semibold", size: 14) ?? UIFont.systemFont(ofSize: 14, weight: .semibold)
        }
        ...
        static var LargeLight : UIFont {
            return UIFont(name: "SFProDisplay-Light", size: 14) ?? UIFont.systemFont(ofSize: 14, weight: .light)
        }
